import { Button, Container, Nav, Navbar, NavDropdown, Form, Row, Col, Card } from "react-bootstrap";
    ...
    <Navbar expand="lg" className="bg-light py-1 border-bottom">
      <Container className="d-flex justify-content-center align-content-center navBarContainer m-xs-0 m-lg-auto">
        <Row className="m-0 w-90">
          <Col xs={2} lg={4} className="d-flex justify-content-center align-content-center">
            <div className="d-flex align-items-center">
              ...
              <Form className="position-relative me-5 d-none d-lg-block">
                ...
                <Form.Control type="search" placeholder="Cerca" className="me-2 ps-5 py-1 pe-5 rounded-5 border-secondary" aria-label="Search" />
              </Form>
            </div>
          </Col>

          <Col xs={8} lg={6} className="d-flex  justify-content-end align-items-center">
            <Nav className="d-flex flex-row justify-content-around align-items-center">
              <Link to={"/"} className="d-flex flex-column align-items-center mx-1">
              ...
              <div className="d-flex flex-column align-items-center mx-1">
                <div>
                  <img className="rounded-5" src={imagePlaceHolder} alt="profileImage" />
                </div>
                <NavDropdown align={"end"} title={<span className="d-none d-lg-inline">Tu</span>} id="navbarScrollingDropdown">
                  <div
                  ...
                  >
                    ...
                    <div className="border-bottom pb-2">
                      ...
                      >
                        <Button variant="outline-primary" className="rounded-5 w-50 mt-1">
                          <p
                            style={{
                              fontSize: 14,
                              fontWeight: 600,
          ...
          {/* dropdown aziende */}
          <Col xs={2} className="d-flex align-items-center justify-content-start border-start">
            <div className="d-flex flex-column align-items-center me-3">
              ...
              <NavDropdown align={"end"} title={<span className="d-none d-lg-inline">Per le aziende</span>} id="navbarScrollingDropdown">
                <Card
                ...
                >
                  <div>
                    ...
                    <div className="d-flex flex-column ms-2" id="aziendeCardLeft">
                      <a href="/" onClick={(e) => e.preventDefault()} className="d-flex align-items-center mb-3">
                  ...
                  <div className="border-start ps-5" id="aziendeCardRight">
                    ...
                    <a href="/" onClick={(e) => e.preventDefault()}>
                      ...
                      <p className="mb-3">Sblocca nuove opportunità di vendita</p>
                    </a>

                    <a href="/" onClick={(e) => e.preventDefault()}>
                      <p className="p1">Offerta di lavoro gratuita</p>
                      <p className="mb-3">Ottieni rapidamente candidati qualificati</p>
                    </a>

                    <a href="/" onClick={(e) => e.preventDefault()}>
                      <p className="p1">Fai pubblicità su LinkedIn</p>
                      <p className="mb-3">Acquisisci clienti e fai crescere la tua azienda</p>
                    </a>
                    ...
                    <a href="/" onClick={(e) => e.preventDefault()}>
                      ...
                      <p className="mb-3">Corsi per formare i tuoi dipendenti</p>
                    </a>

                    <a href="/" onClick={(e) => e.preventDefault()}>
                      <p className="p1">Centro per amministratori</p>
                      <p className="mb-3">Gestisci i dettagli di fatturazione e account</p>
                    </a>
